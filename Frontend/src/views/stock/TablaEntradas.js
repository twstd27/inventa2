...
const TablaEntradas = () => {
  ...
  useEffect(() => {
    getEntradas(pagination.pageIndex, pagination.pageSize, searchRef.current, showDeleted, startDate, endDate)
  ...
  const handleSearch = ({ target }) => {
    ...
    debounceTimer.current = setTimeout(() => {
      ...
      getEntradas(1, pagination.pageSize, target.value, showDeleted, startDate, endDate)
    }, 500)
  }
