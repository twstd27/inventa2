...
const AppHeader = () => {
  ...
  return (
    <CHeader position="sticky" className="mb-4 p-0 print-none" ref={headerRef}>
      <CContainer className="border-bottom px-4" fluid>
        <div
          className="d-flex align-items-center justify-content-between flex-row w-100"
          style={{ minHeight: '56px' }}
        >
          <CHeaderToggler onClick={handleToggleSidebar} style={{ marginInlineStart: '-14px' }}>
            <CIcon icon={cilMenu} size="lg" />
          </CHeaderToggler>
          <CHeaderNav className="ms-auto d-flex align-items-center flex-row">
